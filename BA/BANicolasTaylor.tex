...
Bitte schreib mir ein promp für midjourney um eine vorlage zu bekommen die ich in PIFuHD benutzen kann. Die Person soll martin luther ähnlich sehen.
...
\begin{figure}[h]
 	\centering
\includegraphics[width=14cm]{BilderFuerBA/CGPTMidJourneyMartinLuther/01.png}
        	\caption{Erster Versuch: ChatGPT erstellt Promt für Midjourney}
        	\label{Erster_Versuch_Midjourney_Promt}
\end{figure}
\\
Mit der in Abbildung \ref{Erster_Versuch_Midjourney_Promt} zusehenden Aufforderung, habe ich eine deutsche Ausgabe bekommen. Durch eine kurze Aufforderung kann die Ausgabe von ChatGPT übersetzt werden. 
Midjourney liefert in Englisch in Gegensatz in Deutsch oft ein ähnliches Ergebnis, aber nicht immer. Beobachten kann man bei Promts, wo wörter im Englschen auseinander geschrieben werden, wie zum Beispiel Bussfahrer auf deutsch und buss driver auf englisch.
\\
\begin{figure}
	\centering
	\begin{minipage}[t]{0.45\linewidth}
		\centering
		\includegraphics[width=6cm]{BilderFuerBA/MJ/Bussfahrer.png}
		\caption{Midjourney Prompt: Bussfahrer}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{0.45\linewidth}
		\centering
		\includegraphics[width=6cm]{BilderFuerBA/MJ/buss_driver.png}
		\caption{Midjourney Prompt: buss driver}
	\end{minipage}
