...
\section{KI-Systeme in der Gesellschafft}
Ich möchte an dieser Stelle auf ein Paar gesellschaftliche Punke eingehen, die mich während meiner Arbeit Mit und Über KI-Steme begegnet sind und micht Als Ein-Mann-Videospielentwickler begleitet haben.
...
\\
Ich kann Conzeptgraphiken, UX-Elemente, Texturen in hülle und fülle mit einfachen Promt in Midjourney generieren lassen wozu ich nicht mal im Ansatz im stande währe, da ich kein guter Zeichner bin.
\\
Ich habe viele weiter KI-Systeme ausprobiert wie zum Beispiel MonsterMash, mit dem man mit einem Hintergrundbild und einer Zeichnung mit der Maus, ein einfaches 3D-Modell erzeugen kann. Dieses 3D-Modell kann man mit hilfe von Punkten Animieren.
\\
Ich habe Die Photoshop-Ki von Adobe ausprobiert. Mit diesem KI-System konnte ich Texturen die ich für mein Einfaches Haus mit einem einfachen Einkreisen der gewünschten Stelle einkreisen und mit dem Promt Fenster aus einer Tür zu einem Fenster machen.
\\
Ich wollte ein KI-System Kaedim zu arbeiten. Habe es sein gelassen, da der preis von ca. 15€ promt abgeschreckt haben. Desweiteren ist mir die Methodik ein wenig zu einfach vorgekommen und ich habe über Kaedim rechaschiert.  
