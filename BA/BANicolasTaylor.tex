...
Mein erste Meilenstein ist die Hauptfigur Martin Luther. Ich beginne die Entwicklung der Hauptfigur in dem ich ChatGPT um eine Beschreibung meiner Hauptfigur auffordere. Ich gebe auch an, dass ich die Ausgabe von ChatGPT als Prompt für Midjourney verwenden möchte. 
Ich habe zusätzlich ChatGPT aufgefordert, dass die Vorlage für PIFuHD kompatibel sein sollte
\begin{figure}[h]
 	\centering
...
\end{figure}
\\
Mit der in Abbildung 3 zusehenden Auffoerderung, habe ich eine deutsche Asugabe bekommen. Um das zu beheben forderte ich ChatGPT auf, diesen Prompt zu übersetzen. Meine frühere Erfahrun zeigt mir das ein Prompt in Englisch, ein besseres Ergebnis in Midjourney herforbring. wie in Abbildung 4 und 5 zeige am beispiel Bussfahrer auf deutsch und buss driver auf englisch.
\\
\begin{figure}[h]
	\centering
