...
%\subsection{Erstellung von Midjourney-Prompts mit hilfe von ChatGPT}
\begin{figure}[h]
	\centering
	\includegraphics[width=14cm]{BilderFuerBA/02.png}
...
\subsubsection{Exkurs Midjourney Prompts in englisch und deutsch}
\begin{figure}
	\centering
...
\newpage
\subsection{Prompts in englisch}
\begin{figure}[h]
	\centering
